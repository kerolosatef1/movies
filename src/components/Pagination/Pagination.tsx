...
export default function Pagination({getPage ,pageCount}: { getPage: (page: number) => void; pageCount: number }) {
  ...
  return (
    <ReactPaginate
      ...
      pageLinkClassName="bg-gray-200 text-gray-700 px-3 py-1 block hover:bg-gray-300 cursor-pointer"
      previousClassName="rounded overflow-hidden"
      previousLinkClassName="bg-gray-200 text-gray-700 px-3 py-1 block hover:bg-gray-300 cursor-pointer"
      nextClassName="rounded overflow-hidden"
      nextLinkClassName="bg-gray-200 text-gray-700 px-3 py-1 block hover:bg-gray-300 cursor-pointer"
      breakClassName="rounded overflow-hidden"
      breakLinkClassName="px-3 py-1 block"
      activeClassName="bg-red-600"
      activeLinkClassName="bg-red-600 text-white px-3 py-1 "
    />
  );
}